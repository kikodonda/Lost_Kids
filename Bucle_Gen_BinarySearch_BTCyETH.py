...
def loop():
    while True:
        ...
        kg.seed_input('No se para que es esto pero estaria interesado en que fuera realmente aleatorio, la frase original era esta: Truly random string. I rolled a dice and got 4.')
        key = kg.generate_key()
        # print(key)
